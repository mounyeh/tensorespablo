/*=========================================================================
  ...
  Module:    $RCSfile: ImageViewer.txx,v $
  Language:  C++
  Date:      $Date: 2003/09/28 15:23:12 $
...
=========================================================================*/
#ifndef _ImageViewer_txx
#define _ImageViewer_txx
...
::SetImage(ImageBase<3> * img)
{
  ...
  glSliceView->viewDetails(false);
  glSliceView->viewValue(false);
  Synchronize();
}
...
::viewDetails()
{
  return glSliceView->viewDetails();
}
...
::viewCrosshairs(void)
{
  return glSliceView->viewCrosshairs();
}
