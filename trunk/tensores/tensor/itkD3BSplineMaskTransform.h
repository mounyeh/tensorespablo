/*=========================================================================
  ...
  Module:    $RCSfile: itkD3BSplineMaskTransform.h,v $
  Language:  C++
...
#ifndef __itkD3BSplineMaskTransform_h
#define __itkD3BSplineMaskTransform_h
...
class ITK_EXPORT D3BSplineMaskTransform : public Transform< TScalarType, NDimensions, NDimensions >
{
public:
  //-----------------------------------------------------------------------------------------
  //-----------------------------------------------------------------------------------------
  /** Standard class typedefs. */
  typedef D3BSplineMaskTransform Self;
  ...
  itkTypeMacro( D3BSplineMaskTransform, Transform );
...
protected:
  ...
  ~D3BSplineMaskTransform();
  /** Print contents of an D3BSplineMaskTransform. */
  void PrintSelf( std::ostream &os, Indent indent ) const;

private:
  D3BSplineMaskTransform( const Self& ); //purposely not implemented
...
#include "itkD3BSplineMaskTransform.txx"
#endif

#endif /* __itkD3BSplineMaskTransform_h */
