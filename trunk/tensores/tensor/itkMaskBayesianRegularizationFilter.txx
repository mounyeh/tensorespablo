/*=========================================================================
  ...
  Module:    $RCSfile: itkMaskBayesianRegularizationFilter.txx,v $
  Language:  C++
  Date:      $Date: 2005/05/4 14:28:51 $
  Version:   $Revision: 1.1 
=========================================================================*/
#ifndef _itkMaskBayesianRegularizationFilter_txx
#define _itkMaskBayesianRegularizationFilter_txx
...
MaskBayesianRegularizationFilter< TMaskImage, NDimension >
...
template < class TMaskImage, const unsigned int NDimension >
void MaskBayesianRegularizationFilter< TMaskImage, NDimension >
...
template < class TMaskImage, const unsigned int NDimension >
void MaskBayesianRegularizationFilter< TMaskImage, NDimension >::Initialize()
{
	if( m_Sigma.Size()<NDimension )
		itkExceptionMacro(<< "Cannot Initialize MaskBayesianRegularizationFilter before setting the squared variance!");
	...
	if( w_size==0 )
		itkExceptionMacro(<< "Cannot Initialize MaskBayesianRegularizationFilter before setting the search size!");
...
::ThreadedGenerateData(const OutputImageRegionType& outputRegionForThread, int threadId)
{
	...
	ImageRegionIterator<MaskImageType>		  mask_it; //Mask
	...
	for (fit=faceList.begin(); fit != faceList.end(); ++fit){
		...
		mask_it=ImageRegionIterator<MaskImageType>	   (		  this->GetMask(),   *fit );
