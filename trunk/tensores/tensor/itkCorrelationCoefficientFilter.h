/*=========================================================================
  ...
  Module:    $RCSfile: itkCorrelationCoefficientFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkCorrelationCoefficientFilter_h
#define __itkCorrelationCoefficientFilter_h
...
class ITK_EXPORT CorrelationCoefficientFilter 
	: public ImageToImageFilter<   TInputImage1, TInputImage1  >
{
public:
	/** Standard Self typedef */
	typedef CorrelationCoefficientFilter                            Self;
	...
	itkTypeMacro(CorrelationCoefficientFilter, ImageToImageFilter);
...
private:
  CorrelationCoefficientFilter(const Self&); //purposely not implemented
...
#include "itkCorrelationCoefficientFilter.txx"
#endif
