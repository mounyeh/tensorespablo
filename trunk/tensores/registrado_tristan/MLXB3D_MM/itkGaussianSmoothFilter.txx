/*=========================================================================
  ...
  Module:    $RCSfile: itkGaussianSmoothFilter.txx,v $
  Language:  C++
  Date:      $Date: 2005/05/4 14:28:51 $
  Version:   $Revision: 1.1 
=========================================================================*/
#ifndef _itkGaussianSmoothFilter_txx
#define _itkGaussianSmoothFilter_txx
...
GaussianSmoothFilter< TScalar, NDimension >
...
template < class TScalar, unsigned int NDimension >
void GaussianSmoothFilter< TScalar, NDimension >
::GenerateData( void )
{
 ...
 */
template < class TScalar, unsigned int NDimension >
void GaussianSmoothFilter< TScalar, NDimension >::PrintSelf( std::ostream& os, Indent indent ) const
{
