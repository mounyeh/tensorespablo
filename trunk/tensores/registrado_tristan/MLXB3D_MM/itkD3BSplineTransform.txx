...
template <class TScalarType, unsigned int NDimensions>
const typename D3BSplineTransform<TScalarType, NDimensions>::ParametersType
D3BSplineTransform<TScalarType, NDimensions>::GetInverseParameters( void ) const
{
	//----------------------------------------------------------------------------------------------------
...
template<class TScalarType, unsigned int NDimensions>
void D3BSplineTransform<TScalarType, NDimensions>::Thomas( double* values, double* results, unsigned int* sizes, unsigned int order ) const
{
	//------------------------------------------------------------------------------------------------------------
	unsigned int DIM = 1;
