...
int main( int argc, char *argv[] )
{
	if( argc<4 ){
		...
		std::cerr << "RegisteredImageFile [DownSample=6] [BlockSize=2] [SearchSize=1] [NLevels=5] [GWidth=4] [Sigma=16.0] [NIter=5] [Lambda=0.5]" << std::endl;
		return -1;
	}
	...
	if( argc>11 )
		reg->SetLambda(   (double)( ::atof(argv[11]) )   );
