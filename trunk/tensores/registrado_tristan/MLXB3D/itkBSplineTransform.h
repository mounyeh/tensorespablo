/*=========================================================================
  ...
  Module:    $RCSfile: itkBSplineTransform.h,v $
  Language:  C++
...
/** \brief BSpline transformation of a vector space (e.g. space coordinates)
 *
 ...
 * \ingroup Transforms
 */
template < class TScalarType=double, unsigned int NDimensions=2 >
...
public:
  ...
  void SetNumberOfPoints( const unsigned int pointsx, const unsigned int pointsy );
...
private:
  ...
  // Stores the upper-left corner of the last used 4 by 4 vicinity of the grid. It has to be mutable
  // because we need to change it from the const method GetJacobian()
  mutable unsigned int m_LastVisited[2];
