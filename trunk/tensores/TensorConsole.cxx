...
cout<<"a1\n";
	...
	StrainImageType::Pointer esfuerzo = StrainImageType::New();
	StrainImageType::IndexType start;
	StrainImageType::SizeType size;
	unsigned int a;
cout<<"a2\n";
cout<<"a3\n";
	start.Fill(0);
	size.Fill(10);
cout<<"a4\n";
	StrainImageType::RegionType region;
cout<<"a5\n";
	region.SetSize( size );
...
cout<<"a8\n";
	StrainPixelType f;
	StrainImageType::IndexType indice;
