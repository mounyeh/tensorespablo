...
public:
  ...
  typedef typename InterpolatedImageType::SpacingType SpacingType;
  //-----------------------------------------------------------------------------------------
  //-----------------------------------------------------------------------------------------
  ...
  void InterpolatePoints( std::vector<InputPointType> points, std::vector<InputPointType> values );
