/*=========================================================================
  ...
  Module:    $RCSfile: itkMaskResampleImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMaskResampleImageFilter_h
#define __itkMaskResampleImageFilter_h
...
/** \class MaskResampleImageFilter
 * \brief Resample an image via a coordinate transform
 *
 * MaskResampleImageFilter resamples an existing image through some coordinate
 ...
 */
template <class TInputImage, class TOutputImage, class TMaskImage,class TInterpolatorPrecisionType=double>
class ITK_EXPORT MaskResampleImageFilter:
    public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef MaskResampleImageFilter                           Self;
  ...
  itkTypeMacro(MaskResampleImageFilter, ImageToImageFilter);
  ...
  /** MaskResampleImageFilter produces an image which is a different size
  ...
  /** MaskResampleImageFilter needs a different input requested region than
   * the output requested region.  As such, MaskResampleImageFilter needs
...
protected:
  MaskResampleImageFilter();
  ~MaskResampleImageFilter() {};
  void PrintSelf(std::ostream& os, Indent indent) const;

  /** MaskResampleImageFilter can be implemented as a multithreaded filter.  Therefore,
...
private:
  MaskResampleImageFilter(const Self&); //purposely not implemented
...
#include "itkMaskResampleImageFilter.txx"
#endif
