/*=========================================================================
  ...
  Module:    $RCSfile: itkComputeMeasuresInRegions.h,v $
  Language:  C++
  Date:      $Date: 2008/02/7 14:28:51 $
  Version:   $Revision: 0.0 $
=========================================================================*/
#ifndef __itkComputeMeasuresInRegions_h
#define __itkComputeMeasuresInRegions_h
...
class ITK_EXPORT ComputeMeasuresInRegions : public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
	...
	typedef ComputeMeasuresInRegions                                     Self;
	...
	itkTypeMacro( ComputeMeasuresInRegions, ImageToImageFilter );
	...
	void SetInput2( MaskImageType * image ){
		m_Input2 = image;
	}

	/** Set the output. */
	void SetOutput( OutputImageType * image ){
		m_Output = image;
	}
	
	
	/** Get the second input. */
	MaskImageConstPointer GetInput2( void ){
		return m_Input2;
	}
...
protected:
	...
	virtual ~ComputeMeasuresInRegions() {}
	// Threaded filter!
	void ThreadedGenerateData( const OutputImageRegionType& outputRegionForThread, int threadId );
private:
	ComputeMeasuresInRegions(const Self&);   // purposely not implemented
	void operator=(const Self&);      // purposely not implemented
	// The scalar to compute:
	ScalarParameter m_Scalar;
	unsigned int m_Label;
	InputImageConstPointer m_Input1;
	MaskImageConstPointer m_Input2;
...
#include "itkComputeMeasuresInRegions.txx"
#endif
