...
{
  //std::cout << "inputNumberOfComponents " << inputNumberOfComponents << std::endl;
  //std::cout << "OutputNumberOfComponents " << OutputConvertTraits::GetNumberOfComponents() << std::endl;
  switch(OutputConvertTraits::GetNumberOfComponents())
    ...
    // output number of components is 6 ->DiffusionTensor3d
    case 6:
      {
	switch(inputNumberOfComponents)
	{
	  case 9:
             ConvertVTKTensorToDiffusionTensor3D(inputData, inputNumberOfComponents,outputData, size);
...
void
ConvertPixelBuffer<InputPixelType, OutputPixelType, OutputConvertTraits>
::ConvertVTKTensorToDiffusionTensor3D(InputPixelType* inputData,
			int inputNumberOfComponents,  
                   	OutputPixelType* outputData , int size)
{

		
  InputPixelType* endInput = inputData+ size*inputNumberOfComponents; //size es el tamano del campo tensorial XxYxZ

std::cout<<inputNumberOfComponents<<"   "<<size<<"   "<<(float)inputData[1098]<<std::endl;  
  while(inputData != endInput)
    {
    OutputConvertTraits
	::SetNthComponent(0, *outputData, 
    ...
    OutputConvertTraits
      ::SetNthComponent(4, *outputData, 
                        static_cast<OutputComponentType>
                        (*(inputData+5)));


    OutputConvertTraits
      ::SetNthComponent(5, *outputData, 
                        static_cast<OutputComponentType>
                        (*(inputData+8)));
