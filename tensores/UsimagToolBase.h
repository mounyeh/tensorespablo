...
public:
  ...
  // Tipos auxiliares para lectura y escritura de tensor de esfuerzo
...
//  typedef itk::ImageFileReader< STImageType >        FileSTReaderType;
  ...
  typedef itk::ImageSeriesReader< DeformImageType >  DeformReaderType;
  ...
  typedef itk::ImageSeriesWriter <DeformImageType , DeformImage3DType >	DeformWriterType;
