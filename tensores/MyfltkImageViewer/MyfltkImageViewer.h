...
=========================================================================*/
#ifndef __MyfltkImageViewer_h
#define __MyfltkImageViewer_h
...
template <class ImagePixelType, class OverlayPixelType>
  class MyImageViewer : public GLSliceView<ImagePixelType, OverlayPixelType>
{
public:
  ...
  MyImageViewer(int x,int y,int w,int h, const char * label=0);
  virtual ~MyImageViewer();
  ...
  virtual void ChangeColorMode(int value);   
  virtual void SetColorMax(double value);
  virtual void SetColorMin(double value);
