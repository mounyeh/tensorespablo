...
//	MyTensorConsole->verGlifosStrain(0,0);
//	this->ViewStrainSlice3D();
//	MyTensorConsole->verGlifosStrain(strainSlice->value(),strainTime->value());
//	strainSlice->range( 0.0f, m_VectorSTData[dataId].image->GetLargestPossibleRegion().GetSize()[2]-1 );
//	strainSlice->redraw();
//	strainTime->range( 0.0f, m_VectorSTData[dataId].image->GetLargestPossibleRegion().GetSize()[3]-1 );
//	strainTime->redraw();
...
/***************************************************************************************/
  ...
  this->data_temp = vtkImporter->GetOutput();

  this->data_temp->Update();

  ImageViewerStrain3D->renderSlice( this->data_temp, 2, strainSlice->value() );
