/*=========================================================================
  ...
  Module:    $RCSfile: itkTensorVTKImageIO.cxx,v $
  Language:  C++
...
TensorVTKImageIO::TensorVTKImageIO()
{
...
bool TensorVTKImageIO::OpenVTKFileForReading(std::ifstream& os, 
                                       const char* filename)
...
bool TensorVTKImageIO::OpenVTKFileForWriting(std::ofstream& os, 
                                       const char* filename)
...
bool TensorVTKImageIO::CanReadFile(const char* filename) 
{ 
  std::ifstream file;
  char buffer[256];
...
void TensorVTKImageIO::InternalReadImageInformation(std::ifstream& file)
{
  char line[255];
  std::string text;
...
void TensorVTKImageIO::Read(void* buffer)
{
  std::ifstream file;
...
void TensorVTKImageIO::ReadImageInformation()
{
  std::ifstream file;
  this->InternalReadImageInformation(file);
}

bool TensorVTKImageIO::CanWriteFile( const char* name )
{
...
void TensorVTKImageIO::Write(const void* buffer)
{
  std::ofstream file;
...
void TensorVTKImageIO::PrintSelf(std::ostream& os, Indent indent) const
{
